...
-- Add foreign keys for Documents
...
FOREIGN KEY ([UploadedById]) REFERENCES [dbo].[Users]([Id]) ON DELETE RESTRICT;

ALTER TABLE [dbo].[Documents] 
ADD CONSTRAINT [FK_Documents_Users_CreatedBy] 
FOREIGN KEY ([CreatedById]) REFERENCES [dbo].[Users]([Id]) ON DELETE RESTRICT;

ALTER TABLE [dbo].[Documents] 
ADD CONSTRAINT [FK_Documents_Users_ModifiedBy] 
FOREIGN KEY ([LastModifiedById]) REFERENCES [dbo].[Users]([Id]) ON DELETE RESTRICT;
GO
...
-- Create DocumentTags join table
...
-- Create DocumentTopics join table
...
-- Create DocumentRelationships table
...
-- Create TrainingDocuments table for ML
...
-- Create ModelMetrics table for ML model evaluation
...
-- Create ClassificationResults table for document classification history
...
-- Create DocumentTypeScores table for detailed classification scores
